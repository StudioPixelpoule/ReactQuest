...
export const dataQueryQuest: QuestStep[] = [
  {
...
function PostDetail() {
  ...
  return (
    ...
    hint: "N'oublie pas :\n- D'utiliser des queryKey uniques\n- De typer les réponses\n- De gérer le enabled avec l'id\n- D'afficher les états de chargement",
